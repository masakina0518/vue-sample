...
export const calendarEventMockData: CalendarEventDetail[] = [
  ...
  },
  {
    ...
    userId: '66006b29-727e-4ed8-a3c8-95d4438f66d4',
    name: '音楽発表会',
    start: '2022-05-03 09:00',
    end: '2022-05-03 12:00',
    memo: '小学校',
    shared: true,
  },
  {
    ...
    name: 'ショッピング',
    start: '2022-05-02 13:00',
    end: '2022-05-02 16:00',
    memo: null,
    shared: true,
  },
  {
  ...
  },
  {
    ...
    name: '早帰り',
    start: '2022-05-02 12:00',
    end: '2022-05-02 13:00',
    memo: null,
    shared: true,
  },
  {
  ...
  },
  {
    ...
    end: '2022-05-07 12:00',
    memo: null,
    shared: true,
  },
];

export const todayCalendarEventMockData: CalendarTodayEventDetail[] = [
  {
    id: 'a8b2c7c8-ebe4-4c70-a1d0-dbc42ba777d5',
    userId: '66006b29-727e-4ed8-a3c8-95d4438f66d4',
    name: '休み',
 ...
 * UUIDを生成します。
 */
export const generateUuidMock = () => {
  return '28560989-e09f-4bae-ba77-xxxxxxxxxxxx'.replace(/x/g, () =>
